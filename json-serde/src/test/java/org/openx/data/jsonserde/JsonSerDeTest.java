...
public class JsonSerDeTest {
    ...
    public void testSerializeWithMapping() throws SerDeException, JSONException {
        ...
        assertTrue(stringRepresentation.contains("\"timestamp\":7898"));
        assertTrue(stringRepresentation.contains("\"two\":43.2"));
        assertTrue(stringRepresentation.contains("\"one\":true"));
        assertTrue(stringRepresentation.contains("\"three\":[]"));
        assertTrue(stringRepresentation.contains("\"four\":\"value1\""));
        assertTrue(stringRepresentation.startsWith("{"));
        assertTrue(stringRepresentation.endsWith("}"));

        System.out.println("Output object " + stringRepresentation);
    }
