 ...
 * Licensed under the New BSD License (the "License"); you may not use * this
 * file except in compliance with the License. Unless required * by applicable
...
public class JsonSerDeTest {
    ...
    /**
     * Test of deserialize method, of class JsonSerDe. expects
     * "one,two,three,four" "boolean,float,array&lt;string&gt;,string");
     */
    @Test
    public void testDeserializeArray() throws Exception {
        ...
        JavaStringFloatObjectInspector jsfOi = (JavaStringFloatObjectInspector) soi
            .getStructFieldRef("two").getFieldObjectInspector();
    ...
    public void testDeserializeNull() throws Exception {
        ...
        Writable w = new Text(
            "{\"one\":true,\"three\":[\"red\",\"yellow\",\"orange\", null],\"two\":null,\"four\":null}");
        ...
        ListObjectInspector loi = (ListObjectInspector) soi.getStructFieldRef("three")
    ...
    public void testDeserializePartialFieldSet() throws Exception {
        Writable w = new Text(
            "{\"missing\":\"whocares\",\"one\":true,\"three\":[\"red\",\"yellow\",[\"blue\",\"azure\",\"cobalt\",\"teal\"],\"orange\"],\"two\":19.5,\"four\":\"poop\"}");
        JsonSerDe instance = new JsonSerDe();
        initialize(instance);
        JSONObject result = (JSONObject) instance.deserialize(w);
        assertEquals(result.get("four"), "poop");
     ...
     * System.out.println("serialize"); Object o = null; ObjectInspector oi =
     * null; JsonSerDe instance = new JsonSerDe(); Writable expResult = null;
     * Writable result = instance.serialize(o, oi); assertEquals(expResult,
     * result); }
     */
    // @Test
    public void testSerialize() throws SerDeException, JSONException, Exception {
        ...
        row.add(m);
        fieldNames.add("amap");
        lOi.add(ObjectInspectorFactory.getStandardMapObjectInspector(ObjectInspectorFactory
            .getReflectionObjectInspector(String.class,
                ObjectInspectorFactory.ObjectInspectorOptions.JAVA), ObjectInspectorFactory
            .getReflectionObjectInspector(String.class,
                ObjectInspectorFactory.ObjectInspectorOptions.JAVA)));
        ...
        // after serialization the internal contents of JSONObject are destroyed
        // (overwritten by their string representation
        // (for map and arrays)
    ...
    public void testNumbers() throws SerDeException, JSONException {
        ...
        Text line = new Text(
            "{ cboolean:true, ctinyint:1, csmallint:200, cint:12345,cbigint:123446767687867, cfloat:3.1415, cdouble:43424234234.4243423}");
        ...
        JavaStringByteObjectInspector boi = (JavaStringByteObjectInspector) sf
            .getFieldObjectInspector();
        ...
        JavaStringShortObjectInspector shoi = (JavaStringShortObjectInspector) sf
            .getFieldObjectInspector();
        ...
        JavaStringIntObjectInspector oi = (JavaStringIntObjectInspector) sf
            .getFieldObjectInspector();
        ...
        JavaStringLongObjectInspector bioi = (JavaStringLongObjectInspector) sf
            .getFieldObjectInspector();
        ...
        JavaStringFloatObjectInspector foi = (JavaStringFloatObjectInspector) sf
            .getFieldObjectInspector();
        ...
        JavaStringDoubleObjectInspector doi = (JavaStringDoubleObjectInspector) sf
            .getFieldObjectInspector();
    ...
    public void testHexSupport() throws SerDeException, JSONException {
        ...
        JsonSerDe serde = getNumericSerde();
        Text line = new Text(
            "{ cboolean:true, ctinyint:0x01, csmallint:0x0a, cint:0Xabcd,cbigint:0xabcd121212, cfloat:3.1415, cdouble:43424234234.4243423}");
    ...
    public void testSerializeWithMapping() throws SerDeException, JSONException {
        ...
        assertEquals(
            "{\"timestamp\":7898,\"two\":43.2,\"one\":true,\"three\":[],\"four\":\"value1\"}",
            obj.toString());

        System.out.println("Output object " + obj.toString());
    }

    // {"one":true, "timestamp":1234567,
    // "three":["red","yellow",["blue","azure","cobalt","teal"],"orange"],"two":19.5,"four":"poop"}
    @Test
